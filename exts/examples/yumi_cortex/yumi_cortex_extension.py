...
from omni.isaac.examples.yumi_cortex.yumi_cortex import YumiCortex
from omni.isaac.ui.ui_utils import btn_builder, cb_builder, dropdown_builder, get_style, str_builder


class YumiCortexExtension(BaseSampleExtension):
    def on_startup(self, ext_id: str):
        ...
        behavior_path = (
            ...
            + "/omni/isaac/cortex/sample_behaviors/yumi"
        )
        ...
        super().start_extension(
            menu_name="Cortex",
            submenu_name="",
            name="Yumi Cortex Example",
            title="Yumi Cortex Examples",
            ...
            sample=YumiCortex(self.on_diagnostics),
